.PHONY: all help prod dev down down-volumes restart logs build db-migrate db-seed db-reset db-studio format format-check
...
format:
	docker compose exec nextjs-dev pnpm format

# Check code formatting
format-check:
	docker compose exec nextjs-dev pnpm format:check
